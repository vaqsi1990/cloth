    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-6 py-8">
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  className={`w-full text-black px-4 py-3 border rounded-lg md:text-[18px] text-[16px] text-black focus:outline-none focus:ring-2 focus:ring-black ${errors.gender ? 'border-red-500' : 'border-gray-300'}`}
                >
                ...
                {errors.gender && <p className="text-red-500 md:text-[16px] text-[14px] mt-1">{errors.gender}</p>}
              </div>
              ...
              {formData.allowsPickup && (
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full text-black px-4 py-3 border border-gray-300 rounded-lg md:text-[18px] text-[16px] focus:outline-none focus:ring-2 focus:ring-black"
                  />
          ...
          {showVariantOptions && (
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h2 className="md:text-[20px] text-[18px] text-black font-semibold mb-4">ვარიანტები</h2>
