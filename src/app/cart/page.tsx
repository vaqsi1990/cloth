...
const CartPage = () => {
    ...
    useEffect(() => {
        ...
        if (!selectedItemId || !cartItems.some((item) => item.id === selectedItemId)) {
    ...
    const selectedItemTotal = selectedItem
        ? getItemLineTotal(selectedItem.price, selectedItem.quantity, selectedItem.discount)
        : 0
        ...
        <div className="min-h-screen  py-16">
            <div className="container mx-auto px-4">
                <div className="max-w-6xl mx-auto">
                    ...
                    <p className="text-black md:text-[18px] text-[16px] mb-6">
                        აირჩიეთ ერთი ნივთი გადასახდელად. დანარჩენი ნივთები კალათაში დარჩება.
                    </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white rounded-2xl shadow-sm p-6 lg:sticky lg:top-8">
                                <h2 className="text-xl font-semibold text-black mb-6">გადასახდელი ნივთი</h2>
                                ...
                                <div className="space-y-4 mb-6">
                                    <div className="flex justify-between text-black md:text-[18px] text-[16px] border-t pt-4">
                                        ...
                                        <span className="font-bold text-lg">₾{selectedItemTotal.toFixed(2)}</span>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    {selectedItemId ? (
                                        <Link
                                            href={`/checkout?item=${selectedItemId}`}
                                        ...
                                        <button
                                            type="button"
                                            disabled
                                            className="flex md:text-[18px] text-[16px] font-bold justify-center md:mt-14 items-center w-full mx-auto mt-4 bg-gray-400 text-white px-8 py-4 rounded-lg font-bold uppercase tracking-wide cursor-not-allowed"
                                        >
                                            შეკვეთის გაფორმება
                                        </button>
                                    )}
