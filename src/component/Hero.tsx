    ...
    const heroSlides = [
        {
            ...
            subtitle: ' უახლესი კოლექციები აქ დაგხვდება',
                        ...
                        <div className="relative w-full h-full">
                            ...
                            <div className="absolute inset-0 flex items-center">
                                <div className="text-center md:text-start text-white px-8 md:px-12 lg:px-16 max-w-3xl">
                                    <h1 className="md:text-[30px] text-[24px] font-serif font-bold text-black drop-shadow-lg">
                                        {slide.title}
                                    </h1>
                                    ...
                                    <Link
                                        ...
                                        className="gi-btn-1 rounded-md transition-all duration-[0.3s] ease-in-out overflow-hidden text-center relative py-[10px] max-[767px]:py-[6px] px-[15px] max-[767px]:px-[10px] bg-[#4b5966] text-[#fff] border-[0] md:text-[20px] text-[18px] tracking-[0] font-medium inline-flex items-center  hover:text-[#fff]"
                                    >
                                        {slide.buttonText}
