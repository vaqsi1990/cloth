...
const ChatProvider: React.FC<ChatProviderProps> = ({ children }) => {
  ...
  const chatUi = showChatUi ? (
    <div
      className="fixed bottom-0 right-0 z-[60] flex flex-col items-end justify-end p-4 sm:p-6 pointer-events-none max-lg:bottom-[calc(4rem+env(safe-area-inset-bottom,0px))] max-lg:p-3"
      aria-live="polite"
    >
